/**
 * Illustrative weather-event visuals for the Babylon city (ported from the scenario weather tool onto live incidents).
 *
...
import { fireSpreadProgress, type HazardDraft, type HazardKind, type HazardTrack } from '../weather'
