...
export const ALARM_FACTOR: Record<Hazard, number> = { crash: 2.5, fire: 3, flood: 2, tornado: 4, gas_leak: 3, rain: 1.5, storm: 2 }
export const DEFAULT_DURATION: Record<Hazard, number> = { crash: 900, fire: 1800, flood: 3600, tornado: 600, gas_leak: 1200, rain: 600, storm: 600 }
